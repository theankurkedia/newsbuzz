...
import '../lib/globalStore.dart' as globals;
...
class _BookmarksScreenState extends State<BookmarksScreen> {
  ...
  _onBookmarkTap(article) {
    ...
    if (articleIndex == -1) {
      ...
      this.setState(() {
        globals.bookmarks = globals.bookmarks;
      });
          ...
          ? new Container(
              child: new Center(
                  child: new Icon(Icons.bookmark_border,
                      size: 150.0, color: Colors.grey[500])),
              color: Colors.grey[300],
            )
          : new ListView.builder(
              itemCount:
                  globals.bookmarks.isEmpty ? 0 : globals.bookmarks.length,
                            ...
                            new Row(
                              children: <Widget>[
                                new GestureDetector(
                                  ...
                                  onTap: () {
                                    share(globals.bookmarks[index]["url"]);
                                  },
                                ),
                                new GestureDetector(
                                  child: buildButtonColumn(Icons.bookmark),
                                  onTap: () {
                                    _onBookmarkTap(globals.bookmarks[index]);
                                  },
                                ),
                              ],
                            )
